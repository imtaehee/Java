...
1. Java 에서 제공되는 8EA의 Primitive Data type 의 이해
...
public class PrimitiveTest
{
    ...
    public static void main(String args[]){
        ...
        short s = 1000;
        int i = 1000;
        long l = 1000L;    //<== long의 경우 000l 또는 000L로 int 와 구별

        //실수형
        float f = 1000.5F;    //<== float 의 경우 000F 또는 000f 로 double 과 구별
        double d = 1000.5;
